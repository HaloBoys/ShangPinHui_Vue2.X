  ...
  <div>
    ...
    <div class="main">
      <div class="py-container">
        ...
        <div class="bread">
          ...
          <ul class="fl sui-tag">
            ...
            <li class="with-x" v-show="searchParams.categoryName">
              ...
              <i @click="removeQueryList">×</i>
            </li>
            <!-- 处理 param 参数: (Header 组件搜索框传递的数据) -->
            <li class="with-x" v-show="searchParams.keyword">
              {{ searchParams.keyword }}
              <i @click="removeParamList">×</i>
            </li>
            <!-- 品牌面包屑-->
            ...
            >
              {{ item.split(":")[1] }}
              <i @click="removeSaleAttr(index)">×</i>
            </li>
          </ul>
        </div>
        ...
        <!--selector-->
        <SearchSelector
          @trademark-click="tradeMarkClick"
          @saleattr-click="saleAttrClick"
        />
        ...
        <div class="details clearfix">
          <div class="sui-navbar">
            <div class="navbar-inner filter">
              <!-- 排序功能 -->
              <ul class="sui-nav">
                <li :class="{ active: isOne }" @click="orderClickHandler('1')">
                ...
                <li :class="{ active: isTwo }" @click="orderClickHandler('2')">
                  <a href="javascript:void(0)"
                    >价格
                    <i
                      v-show="isTwo"
...
export default {
  ...
  methods: {
    ...
    removeParamList() {
      ...
      // 清空 Header 组件搜索框的数据: (全局事件总线)
      this.$bus.$emit("clean-search");
    },
    // 接收 SearchSelector 子组件中的数据(自定义事件处理函数)
    ...
    // 页码点击数据传递
    paginationClickHandler(pagenum) {
