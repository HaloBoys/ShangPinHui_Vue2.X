  ...
  <div class="pay-main">
    <div class="pay-container">
      <div class="checkout-tit">
        ...
        <div class="paymark">
          ...
          <span class="fr"
            ...
            ><em class="orange money">￥{{ nativeInfo.totalFee }}</em></span
          >
        </div>
      </div>
      ...
      <div class="checkout-steps">
        ...
        <div class="submit">
          <a class="btn" @click="weixinPay">立即支付</a>
        </div>
      </div>
    </div>
  </div>
...
export default {
  ...
  methods: {
    ...
    async weixinPay() {
      // 生成二维码图片地址
      let qrCode = await QRCode.toDataURL(this.nativeInfo.codeUrl);
      this.$alert(`<img src="${qrCode}" />`, "微信支付", {
        ...
        showClose: false,
        // MessageBox 关闭前的回调，会暂停实例的关闭，注意此处要用箭头函数（this）
